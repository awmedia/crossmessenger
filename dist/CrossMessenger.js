	    ...
	    function CrossMessenger(config) {
	        ...
	        _this._send = function (message) {
	            ...
	            try {
	                ...
	                _this._targetFrame.postMessage(serializedMessage, _this._targetOrigin);
	            } catch (error) {
	            ...
	            if (isValidReply) {
	                ...
	                if (expectReply) {
	                    ...
	                    if (_this._messageHandler) {
	                        try {
	                            replyPayload = _this._messageHandler(message, _this);
	                        } catch (error) {
	                ...
	                } else if (_this._messageHandler) {
	                    _this._messageHandler(message, _this);
	                }
	        ...
	        _this._targetOrigin = (0, _get3.default)(config, 'targetOrigin', '*');
	        _this._messageScope = config.messageScope;
	        _this._messageHandler = (0, _get3.default)(config, 'messageHandler');
